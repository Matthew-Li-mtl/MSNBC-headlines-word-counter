...
The data from the most recent scrape will be stored as these two files in msnbc/msnbc/word_data/output/word_count and msnbc/msnbc/word_data/output/raw_word_repeats
